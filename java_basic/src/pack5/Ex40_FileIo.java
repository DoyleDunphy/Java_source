...
// 1byte 단위의 데이터에 대한 파일 입출력 - 보통 클래스의 이름에 stream 이 포함
// 문자,그림,미디어 등 다양한 종류의 데이터 처리가 가능
public class Ex40_FileIo {
...
//		String ss = "kor"+"eng"; <- 자바에서는 문자열 더하기 비권장 ( 메모리 낭비가 심함 )
...
//		StringBuilder builder = new StringBuilder();
	...
	public static void main(String[] args) {
		...
		Ex40_FileIo fileIo = new Ex40_FileIo();
